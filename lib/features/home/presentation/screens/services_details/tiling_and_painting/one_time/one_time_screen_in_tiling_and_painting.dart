...
class OneTimeScreenInTilingAndPainting extends StatefulWidget {
  const OneTimeScreenInTilingAndPainting({super.key});
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Center(
                      child: Text('20-30 M', style: OStyles.bodyLargeBold.copyWith(color: selectedSpecificService == index ?  OColors.whiteColor : OColors.primaryColor500)),
                    ),
                  ),
                );
              },
