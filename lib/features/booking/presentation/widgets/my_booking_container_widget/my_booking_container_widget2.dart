            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12.h),
                  ThirdButtonWidget(isRejected: false,widgetInButton: Text(widget.buttonText, style: OStyles.bodyXSmallSemiBold.copyWith(color: OColors.whiteColor)), textStyle: OStyles.bodyXSmallSemiBold.copyWith(color: OColors.whiteColor), containerColor: widget.containerColor, width: 76.w, height: 30.h,borderRadius: 6.r, onTap: () {  },),
                ],
              ),
              const Spacer(),
              InkWellWidget(
