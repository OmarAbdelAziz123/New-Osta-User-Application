...
class MaskedTextWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String maskedData = data.contains('@') ? maskEmail(data) : maskPhoneNumber(data);

    return Text(maskedData, style: OStyles.bodyLargeBold.copyWith(color: OColors.blackColor));
  }
  ...
  String maskPhoneNumber(String phoneNumber) {
    ...
    if (phoneNumber.length > 14) {
      ...
      return phoneNumber; /// Or some form of masking as deemed appropriate
    }
  }
